    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('users') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('users') }}"><i class="fas fa-users"></i> <span>Data User</span></a>
            </li>
            <li class="{{ Request::is('data-master') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('data-master') }}"><i class="fas fa-file"></i> <span>Data Master</span></a>
            </li>
            <li class="{{ Request::is('profile') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('profile') }}"><i class="fas fa-file"></i> <span>Data Siswa / Guru</span></a>
            </li>
            <li class="{{ Request::is('laporan') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('laporan') }}"><i class="fas fa-gear"></i> <span>Laporan</span></a>
            </li>
